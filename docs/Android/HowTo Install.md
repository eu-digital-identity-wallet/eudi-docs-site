...
For the proximity flow (see below), you will also need to download the Android Verifier app. More information can be found [here](https://github.com/eu-digital-identity-wallet/eudi-app-android-wallet-ui/blob/main/wiki/verifier_proximity.md)
