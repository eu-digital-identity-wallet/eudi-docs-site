...
| Verifier  | A relying party requires a verifier to accept and verifie Attestations presented by wallet user. Verifiers can be used in both online and proximity use cases.|[Build your Verifier](../Build Verifier) |
