# Technical Deep Dive - mDL Verifier Developers Workflow
...
Nevertheless, this section outlines essential integration dependencies and pre-requisites procedures for organizations (acting as mDL Verifiers/Relying Parties) to successfully launch their mDL verification solution using the EUDI Wallet Reference Implementation.
...
The verification process supports both proximity and remote presentation flows, implementing the protocols specified in ISO/IEC 18013-5 and OpenID4VP respectively. Please refer to the [Libraries & SDKs](#libraries--sdks) section on how to build and test the mDL Verifier components.
...
The mDL Reader is a mobile application that can request, receive, and verify the integrity and authenticity of an mDL for proximity presentation flows. It is controlled by an mDL Verifier, which is a person or organization. This section focuses explicitly on the mDL Reader.
