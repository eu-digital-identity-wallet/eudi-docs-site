...
- [Initialize Transaction](https://github.com/eu-digital-identity-wallet/eudi-srv-web-verifier-endpoint-23220-4-kt/blob/main/src/main/kotlin/eu/europa/ec/eudi/verifier/endpoint/port/input/InitTransaction.kt){:target="_blank"}, where Verifier may define whether it wants to request a SIOP or OpenID4VP or combined request
...
An Open API v3 specification of these operations is available [here](https://github.com/eu-digital-identity-wallet/eudi-srv-web-verifier-endpoint-23220-4-kt/blob/main/src/main/resources/public/openapi.json){:target="_blank"}.
