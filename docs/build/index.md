...
| Relying Party  | A relying party requires a verifier to accept and verify Attestations presented by wallet user. Verifiers can be used in both remote and proximity use cases.|[Build your Remote Verifier](./build-your-remote-verifier/index.md) <br/> Build your Proximity Verifier](./build-your-proximity-verifier/index.md) |
