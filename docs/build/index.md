...
In this section, you will find comprehensive guidance on leveraging the [EUDI Wallet Reference Implementation](../index.md) to build your own EUDI Wallet, Issuer or Verifier. The reference implementation provides open-source code libraries, tools and sample applications to help you get started quickly and efficiently.
...
| Relying Party  | A relying party requires a verifier to accept and verify Attestations presented by wallet users. Verifiers can be used in both remote and proximity use cases. | [Build your Remote Verifier](./build-your-remote-verifier/index.md) <br/><br/> [Build your Proximity Verifier](./build-your-proximity-verifier/index.md) |
