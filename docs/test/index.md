...
[Instructions](./wallet-application/index.md) are provided on how to install the EUDI Wallet Application on your mobile phone (Android or iOS) and initialise it through issuing and presenting attestations.

## Test with the Issuer

[Test](./issuer.md) various issuance flows of OpenID4VCI with your wallet.

## Test with the Online Verifier

[Test](./online-verifier.md) how your wallet implementation responds to a credential request from a verifier. 
