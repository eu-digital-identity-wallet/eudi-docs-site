...
This guide is primarily targeted at technical professionals responsible for designing and building mDL verification solutions. This includes developers, solution architects and engineers from both public and private sector organisations implementing Relying Party services that need to verify mobile Driving Licences.
...
This guide is structured to mirror the implementers' hub sections providing similar navigation. The main body of this guide focuses on the lifecycle and technical implementation details relevant to Mobile Driving Licence (mDL) verification, including:
