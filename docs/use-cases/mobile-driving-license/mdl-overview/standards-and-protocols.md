...
- [ISO/IEC 18013-7](https://www.iso.org/standard/91154.html) augments the capabilities of the mobile driving licence (mDL) standardized in ISO/IEC 18013-5 with the presentation of a mobile driving licence to a reader over the internet.
