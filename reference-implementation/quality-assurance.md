...
- **Requirements:** [Performance Requirements](https://github.com/eu-digital-identity-wallet/eudi-doc-testing-application/blob/main/doc/performance/performance_requirements.md).
- **Test Specifications**: [Performance Test Specifications](https://github.com/eu-digital-identity-wallet/eudi-doc-testing-application/blob/main/doc/performance/performance_specifications.md).
...
| Performance | - _Android Studio Profiler_ for local device execution on real Android device, <br/> - _Xcode Instruments_ for local device execution on real iOS device, <br/> - _BrowserStack App Live_ for tests executed across multiple real Android and iOS devices in the BrowserStack device farm.|
...
| 2025.12.34-Demo | Performance | - [Performance test results](https://github.com/eu-digital-identity-wallet/eudi-doc-testing-application/blob/milestone/2025.Q4/doc/performance/performance_test_results.md#test-execution-and-results) | 🔄 In progress |
